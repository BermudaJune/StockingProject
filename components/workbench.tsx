        ...
        <div className="stack">
          <section className="panel panel-strong">
            ...
            <div className="section">
              ...
              <div className="stack">
                <div className="field">
                  <label htmlFor="mainPrompt">P步提示词（袜子产品图生成 product_1~3）</label>
                ...
                <div className="field">
                  <label htmlFor="stepTwoPrompt">C步提示词（result_B + 背景 生成 result_0）</label>
...
function buildSingleStepAPrompt(stepAPrompt: string): string {
  ...
  if (withDetailLock.includes("Step A 袜子硬约束")) {
    return withDetailLock;
  }
  return `${withDetailLock}\n\n${STEP_A_SOCK_LOCK}`;
}
...
function buildSingleStepBPrompt(stepBPrompt: string): string {
  ...
  if (withOutfitScope.includes("【Step B 鞋袜锁定（最高优先级，必须）】")) {
    return withOutfitScope;
  }
